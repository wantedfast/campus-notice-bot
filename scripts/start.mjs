...
const child = spawn(process.execPath,[`${standalone}/server.js`],{
  stdio:'inherit', env:{...process.env,HOSTNAME:process.env.HOSTNAME || '0.0.0.0',PORT:process.env.PORT || '3000',DATABASE_PATH:resolve(process.env.DATABASE_PATH || './data/campus.sqlite')}
});
